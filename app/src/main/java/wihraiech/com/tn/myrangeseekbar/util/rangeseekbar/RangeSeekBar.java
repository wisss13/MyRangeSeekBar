...
import wihraiech.com.tn.myrangeseekbar.R;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.seek_thumb_normal1);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(),
            R.drawable.seek_thumb_pressed1);
    private final Bitmap thumbDisabledImage = BitmapFactory.decodeResource(getResources(),
            R.drawable.seek_thumb_disabled1);
    ...
    /**
     * Default color of a {@link RangeSeekBar}, #FFA500. This is also known as "Ice Cream Sandwich" blue.
     */
    //public static final int DEFAULT_COLOR = Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xFF, 0xA5, 0x0);
    /**
